...
class ComprobanteMultiSheetExport implements WithMultipleSheets
{

  public function sheets(): array
  {
     
    $coleccidatos = $this->getdata();

    $sheets = [
      new DatosCabeceraExport($coleccidatos->comprobantes), //
      new DatosDetalleExport($coleccidatos->detalles), //
      
      //new PinesExportSheet($request, $book->id, $book->name)
    ];
    return $sheets;
  }
  /**
   * Otener datos pra explorar
   * @return (objeto)[
  ...
  public function getdata()
  {
    ...
    $datos_comprobate = collect();
    $datos_detalle = collect();
    ...
    foreach ($query_cab as $querycol) {
      ...
      $datos_comprobate->push($comprobante);
      //dd($querycol->toArray());
      //=>$querycol
    ...
    // echo $datos;
    return (object)[
      'comprobantes'  => $datos_comprobate,
      'detalles'  => $datos_detalle,
    ];
  }
